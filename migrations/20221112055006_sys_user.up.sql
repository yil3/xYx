...
comment on column sys_user.salt is '用户密码盐';
...
insert into sys_user (id, password, salt, origin, created_at, updated_at)
values ('00000000-0000-0000-0000-000000000000', '123','xxsalt', 'system', now(), now()),
('00000000-0000-0000-0000-000000000001', 'test', 'xxsalt', 'system', now(), now());
